 ...
 * Обязательно нужно создать отдельную ветку для изменений.
 * Далее отправляем изменения на СВОЙ удаленный репозиторий через команду *git push*
 * После проделанных действий, на удаленном аккаунте должна появиться возможность отправить предложение с изменениями автору изначального репозитория, кнопка: *pull request*


## 17.1 Для переноса нашего локального репозитория в удаленный аккаунт нужно(привязка):

 1. На сайте GitHub в правом верхнем углу нажать *+*, выбрать название и создать репозиторий удаленно.
 2. Выполнить последовательность действий на локальной программе Git, которые написаны на сайте. Ввести команды указанные там.
 3. Если все шаги выполнены верно, то на удаленном репозитории появятся файлы с локального репозитория.

 * Для переноса локальных изменений в удаленный репозиториый нужно выполнить следующую команду: *git push* 
 * Для выгрузки из удаленного в локальный репозиторий нужно ввести команду: *git pull*
